Master branch is deprecated, the branch 'Summer_refactor' represents the most current version of this pipeline. Need external testing before merging the Summer_refactor branch into master. 
